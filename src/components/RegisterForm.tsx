    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-2xl p-8 max-w-md mx-4 shadow-2xl transform animate-bounce-in">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 mb-1">Welcome to ClassinNews, <span className="font-semibold text-red-600">{name}</span>!</p>
...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("[Register] Data:", { ...requestBody, password: requestBody.password ? "***" : undefined })
      ...
      console.log("[Register] Storing token and user...")
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="mb-6 flex gap-2 bg-white rounded-xl p-1 border border-gray-200 shadow-sm">
              <button
                ...
                className={"flex-1 py-2 px-4 rounded-lg font-semibold text-sm transition-colors " + (regMethod === "email" ? "bg-red-600 text-white" : "text-gray-600 hover:bg-gray-50")}
              >
              ...
              {regMethod === "social" ? (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                  >
