    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-2xl p-8 max-w-sm mx-4 shadow-2xl">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-1">Registration Successful!</h3>
          <p className="text-gray-600">Welcome, <span className="font-semibold text-red-600">{name}</span>!</p>
      ...
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-red-600 via-red-700 to-red-900 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center px-16 text-white">
            ...
            <p className="text-xl text-red-100 mb-8 leading-relaxed">Join thousands of readers who trust us for quality journalism.</p>
